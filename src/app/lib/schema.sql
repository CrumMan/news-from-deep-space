...
CREATE UNIQUE INDEX IF NOT EXISTS combined_keywords_unordered_pair ON combined_keywords (
  LEAST(fk_keyword1, fk_keyword2),
  GREATEST(fk_keyword1, fk_keyword2)
);
CREATE INDEX IF NOT EXISTS combined_keywords_fk_keyword1_idx ON combined_keywords (fk_keyword1);
CREATE INDEX IF NOT EXISTS combined_keywords_fk_keyword2_idx ON combined_keywords (fk_keyword2);